    ...
    <div className='projects'>
      ...
      <div className='projectContainer'>
        <div className='screenshotContainer'>
          ...
          <div className='screenshot'>
            <a href='https://www.mixeddrinkmenu.com' target='_blank' rel='noreferrer'><img src={Screenshot2} alt='Screenshot from website'></img></a>          </div>
          <span className='space'></span>
          <div className='screenshot'>
            <a href='https://www.mixeddrinkmenu.com' target='_blank' rel='noreferrer'><img src={Screenshot3} alt='Screenshot from website'></img></a>          </div>
        </div>
        <div className='descriptionContainer'>
          <div className='description'>
            <h1>Mixed Drink Menu</h1>
